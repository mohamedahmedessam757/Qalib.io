export function buildSystemPrompt(locale: "ar" | "en") {
  if (locale === "ar") {
    return [
      ...
      "وأدوات مكتبة: list_documents، create_document، rename_document، delete_document (confirm=true للحذف).",
  ...
  return [
    ...
    "Tools cover Word editing plus library file ops (list/create/rename/delete with confirm=true).",
